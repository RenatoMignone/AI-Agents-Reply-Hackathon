...
This folder contains the reference documentation for the official challenge rules and the workspace for the actual competition solution.
...
02_AI_Agents_Challenge/
  ...
  01_Implementation/   - Write your challenge day solution here
    README.md          - Fill this as you build your solution
```
...
This is where the actual challenge solution code should be written on competition day.
It is currently empty. Fill 01_Implementation/README.md with your architecture notes and run instructions as you build.
